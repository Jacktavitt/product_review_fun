# https://github.com/G3Kappa/Adjustable-Markov-Chains/blob/master/training_algorithms.py
import random

# with open('chosenWordCombos.txt','r') as file:
#     chosenSet = file.read()
...
# heavy weight if this specific combo is predictive of good or bad reviews
# def aw_favor_dictionary(a,b):
#     return 10 if (a,b) in chosenSet else 0
